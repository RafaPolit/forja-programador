...
module.exports = function() {
  ...
  followers.determine_followers = function(lost_sleep) {
    ...
    assess_if_lost_followers(sleep_lost_above_acceptable);
  };

  function assess_if_lost_followers(sleep_lost_above_acceptable) {
    if(sleep_lost_above_acceptable > 0) {
      var groups_of_30_minutes = Math.ceil(sleep_lost_above_acceptable / 30);
      assess_lost_followers(groups_of_30_minutes);
    }
  }

  function assess_lost_followers(groups_of_30_minutes) {
